...
const defaultMessages = {
    ...
    en: {
      ...
      password: 'Password rules: The password must have at least one character, one number, and one special character, and must also have a minimum of 8 characters in length.',
    ...
    fr: {
      ...
      password: 'Attention: Le mot de passe doit comporter au moins une lettre, un chiffre, et un caractère spécial, il doit aussi avoir une longueur de 8 caractères minimum.',
